...
const korisnici_router_1 = __importDefault(require("./routers/korisnici.router"));
...
router.use('/users', korisnici_router_1.default);
...
app.use('/books', express_1.default.static(path_1.default.join('books')));
app.use('/', router);
